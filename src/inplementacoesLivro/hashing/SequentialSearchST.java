 ...
 * <p>
 * This implementation uses a <em>singly linked list</em> and <em>sequential
 * search</em>. The <em>put</em> and <em>delete</em> operations take
 * &Theta;(<em>n</em>). The <em>get</em> and <em>contains</em> operations takes
 * &Theta;(<em>n</em>) time in the worst case. The <em>size</em>, and
